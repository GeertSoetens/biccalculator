...
document.addEventListener('deviceready', function() {
    ...
    function calc() {
        ...
        // Calculate results
        toff = (1 - ((parseFloat(vo.value.replace(/,/, '.')) + parseFloat(vd.value.replace(/,/, '.'))) / (parseFloat(vin.value.replace(/,/, '.')) - parseFloat(vsw.value.replace(/,/, '.')) + parseFloat(vd.value.replace(/,/, '.'))))) * (1 / parseFloat(freq.value.replace(/,/, '.')) * 1000);
        ...
        etop = (parseFloat(vo.value.replace(/,/, '.')) + parseFloat(vd.value.replace(/,/, '.'))) * toff;
